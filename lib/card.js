...
// ---------- tier themes (Lil bro) ----------
const TIERS = {
  ungraded:  { label: "UNGRADED",  accent: "#7C8597", accent2: "#5A6273", glowN: 0, foil: false, holo: false, gem: "#7C8597" },
  common:    { label: "COMMON",    accent: "#46C07E", accent2: "#2F9E63", glowN: 0, foil: false, holo: false, gem: "#46C07E" },
  rare:      { label: "RARE",      accent: "#4F92F2", accent2: "#2E6BD6", glowN: 2, foil: false, holo: false, gem: "#4F92F2" },
  epic:      { label: "EPIC",      accent: "#A974F5", accent2: "#7E45E0", glowN: 3, foil: true,  holo: false, gem: "#A974F5" },
  legendary: { label: "LEGENDARY", accent: "#F3B03A", accent2: "#E08A1E", glowN: 4, foil: true,  holo: false, gem: "#F3B03A" },
  mythical:  { label: "MYTHICAL",  accent: "#FF7AD9", accent2: "#8AE2FF", glowN: 5, foil: true,  holo: true,  gem: "#FFFFFF" },
};
...
async function renderCard(file, outPath, opts = {}) {
  ...
  const tier = computeTier(persona, { faceResolved: face.resolved, inRegistry });
